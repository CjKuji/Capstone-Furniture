    ...
    <div className="flex flex-col bg-[#0F0A06] min-h-screen text-white">
      ...
      <div className="flex lg:flex-row flex-col gap-6 mx-auto px-4 sm:px-6 py-6 w-full max-w-7xl">
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          {/* 3D controls hint */}
          {modelUrl && (
            <div className="flex items-center justify-center gap-6 px-5 py-3 bg-white/[0.03] border border-white/5 rounded-2xl text-white/30 text-xs">
        ...
        <div className="flex flex-col gap-4 lg:w-[390px] xl:w-[440px] shrink-0">
          ...
          <button
            ...
            className="bg-[#D4A97A] hover:bg-[#C4976A] shadow-lg py-4 rounded-full w-full font-bold text-[#1C1209] text-sm active:scale-[0.99] transition-all mt-auto"
          >
            Customize & Order
          </button>
        </div>
